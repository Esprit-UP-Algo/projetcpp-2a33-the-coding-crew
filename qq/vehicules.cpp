...
QSqlQuery query;
query.prepare("INSERT INTO GESTION_VEHICULE (MATRICULE,CAPACITE,IDC,DATEE)"
              "VALUES (:matricule ,:capacite,:idc,:datee)");
...
{
 QSqlQuery query;
query.prepare("UPDATE  GESTION_VEHICULE set  CAPACITE =:capacite,IDC=:idc,DATEE=:datee  where MATRICULE=:matricule ");
