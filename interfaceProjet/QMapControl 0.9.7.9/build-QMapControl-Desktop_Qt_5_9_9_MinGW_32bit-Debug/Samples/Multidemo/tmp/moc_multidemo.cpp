...
#include "../../../../QMapControl/Samples/Multidemo/src/multidemo.h"
...
void Multidemo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Multidemo::setX)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Multidemo::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Multidemo::setY)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Multidemo::zoomIn)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (Multidemo::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Multidemo::zoomOut)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject Multidemo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Multidemo.data,
      qt_meta_data_Multidemo,  qt_static_metacall, nullptr, nullptr}
};
