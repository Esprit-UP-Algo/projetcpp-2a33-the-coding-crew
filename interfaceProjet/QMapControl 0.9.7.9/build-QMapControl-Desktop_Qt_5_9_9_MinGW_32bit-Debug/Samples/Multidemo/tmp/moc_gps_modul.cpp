...
#include "../../../../QMapControl/Samples/Multidemo/src/gps_modul.h"
...
void GPS_Modul::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPS_Modul::new_position)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GPS_Modul::changed)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject GPS_Modul::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GPS_Modul.data,
      qt_meta_data_GPS_Modul,  qt_static_metacall, nullptr, nullptr}
};
